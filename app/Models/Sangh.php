...
class Sangh extends Model
{
    ...
    protected $fillable = [
        ...
        'female',
        'total_members',
        'pradeshik_admission_fee',
        'pradeshik_annual_fee',
        'pradeshik_development_fee',
        'address',
        'road_path',
        'ward_section',
        'president',
    ...
    protected $casts = [
        ...
        'date_meeting'  => 'date',
        'receipt_date'  => 'date',
        'pradeshik_admission_fee' => 'decimal:2',
        'pradeshik_annual_fee' => 'decimal:2',
        'pradeshik_development_fee' => 'decimal:2',
